...
var EMAIL_TEMPLATES = {
  pledge: {
    ...
    bodies: [
      ...
      "Dear {title} {lastName},\n\nI hope this message finds you well. As one of your constituents in {city}, I'm writing about something I feel strongly about: the role of science in our state's policymaking.\n\nThe SAFE Action invites elected officials to take a pledge supporting evidence-based health policy. Taking this pledge would send a powerful message to your constituents that you prioritize facts and science.\n\nLearn more: {pledgeUrl}\n\nThank you for representing us.\n\nWarm regards,\n{name}\n{city}, {state}",
